...
const UBIFLOW_URI = 'https://sw.ubiflow.net/diffusion-annonces.php?MDP_PARTENAIRE=a4d04dd3423c4ad61816f3d04005f999798f3399&DIFFUSEUR=SITE_FIDUCAR&ANNONCEUR=ag942850'
...
let a = async function run () {
  while (true) {
      ...
      try {
        ...
        const annonces = await axios.get(UBIFLOW_URI).then(async r => r.data.annonce)
